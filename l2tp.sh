...
preinstall_l2tp(){
    ...
    read -p "(Default PSK: anwangdaohang.com):" mypsk
    [ -z ${mypsk} ] && mypsk="anwangdaohang"

    echo "Please enter Username:"
    read -p "(Default Username: anwangdaohang.com):" username
    [ -z ${username} ] && username="anwangdaohang.com"
